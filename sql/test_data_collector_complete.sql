...
VALUES
(101, 'collector1@example.com', '$2a$10$dummyHashedPassword1', 'collector1_user', '0901111111', 3, 'ACTIVE', '2024-01-15 08:00:00', '2024-01-15 08:00:00'),
(102, 'collector2@example.com', '$2a$10$dummyHashedPassword2', 'collector2_user', '0902222222', 3, 'ACTIVE', '2024-03-20 09:00:00', '2024-03-20 09:00:00'),
(103, 'collector3@example.com', '$2a$10$dummyHashedPassword3', 'collector3_user', '0903333333', 3, 'INACTIVE', '2023-11-01 10:00:00', '2023-11-01 10:00:00'),
(104, 'collector4@example.com', '$2a$10$dummyHashedPassword4', 'collector4_user', '0904444444', 3, 'ACTIVE', '2024-06-10 09:00:00', '2024-06-10 09:00:00');
-- Note: Adjusted columns to match users table schema (email, password_hash, full_name, phone, role_id...)
-- Original script had username, password which are not in users table. Assuming 3 is COLLECTOR role_id.

-- ============================================================================
-- PREREQUISITE 2: ENTERPRISES
-- ============================================================================

INSERT IGNORE INTO enterprise (id, name, tax_code, email, phone, address, status, created_at)
VALUES
(1, 'Công ty Thu Gom Rác ABC', '0123456789', 'enterprise1@example.com', '0901234567', '123 Đường ABC, Quận 1, TP.HCM', 'active', '2023-01-01 10:00:00');
-- Note: 'enterprises' -> 'enterprise' (singular in schema)

-- ============================================================================
-- PREREQUISITE 3: CITIZENS (để tạo waste_reports)
-- ============================================================================

INSERT IGNORE INTO citizens (id, user_id, full_name, phone, address, created_at)
VALUES
(1, 101, 'Nguyễn Văn Dân', '0912345678', '456 Đường XYZ, Quận 1, TP.HCM', '2024-01-01 10:00:00');
-- Note: user_id 101 is used for collector in previous block, conflict? 
-- Original script used user_id 2 for citizen. Let's assume user_id 2 exists or use a new one.
-- I'll use 401 from generated_test_data_collector.sql if possible, or just create a user for citizen.
-- To be safe, let's create a user for citizen first.
INSERT IGNORE INTO users (id, email, password_hash, full_name, phone, role_id, status, created_at, updated_at)
VALUES (402, 'citizen_complete@example.com', '$2a$10$dummyHash', 'Nguyễn Văn Dân', '0912345678', 4, 'active', NOW(), NOW());

INSERT IGNORE INTO citizens (id, user_id, full_name, phone, address, created_at)
VALUES (2, 402, 'Nguyễn Văn Dân', '0912345678', '456 Đường XYZ, Quận 1, TP.HCM', '2024-01-01 10:00:00');
...
INSERT IGNORE INTO waste_types (id, code, name, description, point_per_kg, created_at, updated_at)
VALUES
(1, 'RECYCLABLE', 'Rác tái chế', 'Giấy, nhựa, kim loại có thể tái chế', 10.00, '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
(2, 'ORGANIC', 'Rác hữu cơ', 'Rác thực phẩm, lá cây', 5.00, '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
(3, 'ELECTRONIC', 'Rác điện tử', 'Thiết bị điện tử cũ', 15.00, '2023-01-01 00:00:00', '2023-01-01 00:00:00');

-- ============================================================================
-- PREREQUISITE 5: WASTE_REPORTS
-- ============================================================================

INSERT IGNORE INTO waste_reports (id, report_code, citizen_id, waste_type_id, latitude, longitude, address, description, images, status, created_at, updated_at)
VALUES
(1, 'WR-20260205-001', 2, 1, 10.77580000, 106.70550000, '123 Nguyễn Huệ, Q1', 'Rác tái chế khoảng 10kg', '["https://example.com/waste1.jpg"]', 'ASSIGNED', '2026-02-05 05:50:00', '2026-02-05 06:00:00'),
(2, 'WR-20260205-002', 2, 1, 10.77600000, 106.70600000, '456 Lê Lợi, Q1', 'Rác giấy 8kg', '["https://example.com/waste2.jpg"]', 'ACCEPTED_COLLECTOR', '2026-02-05 06:20:00', '2026-02-05 06:45:00'),
(3, 'WR-20260205-003', 2, 2, 10.77650000, 106.70650000, '789 Trần Hưng Đạo, Q1', 'Rác hữu cơ 15kg', '["https://example.com/waste3.jpg"]', 'ON_THE_WAY', '2026-02-05 06:50:00', '2026-02-05 07:20:00'),
(4, 'WR-20260204-001', 2, 2, 10.77700000, 106.70700000, '321 Hai Bà Trưng, Q1', 'Rác sinh hoạt 15.5kg', '["https://example.com/waste4.jpg"]', 'COLLECTED', '2026-02-04 07:50:00', '2026-02-04 09:00:00'),
(5, 'WR-20260203-001', 2, 1, 10.77800000, 106.70800000, '654 Pasteur, Q1', 'Rác tái chế 22.3kg', '["https://example.com/waste5.jpg"]', 'COLLECTED', '2026-02-03 09:50:00', '2026-02-03 11:15:00'),
(6, 'WR-20260205-004', 2, 1, 10.77900000, 106.70900000, '987 Võ Văn Tần, Q3', 'Rác nhựa 5kg', '["https://example.com/waste6.jpg"]', 'ASSIGNED', '2026-02-05 06:55:00', '2026-02-05 07:00:00'),
(7, 'WR-20260205-005', 2, 3, 10.78000000, 106.71000000, '111 Cách Mạng Tháng 8, Q3', 'Rác điện tử 3kg', '["https://example.com/waste7.jpg"]', 'ACCEPTED_ENTERPRISE', '2026-02-05 07:10:00', '2026-02-05 07:15:00'),
(8, 'WR-20260205-006', 2, 2, 10.78100000, 106.71100000, '222 Điện Biên Phủ, Q3', 'Rác hữu cơ 12kg', '["https://example.com/waste8.jpg"]', 'PENDING', '2026-02-05 07:30:00', '2026-02-05 07:30:00');
...
VALUES
(101, 1, 'collector1@example.com', 'Nguyễn Văn A', 'COL-001', 
 'TRUCK', '29A-12345', 'AVAILABLE',
 '2026-02-05 07:00:00',
 50, 45, 1250.50, '2024-01-15 08:00:00'),

(102, 1, 'collector2@example.com', 'Trần Thị B', 'COL-002',
 'MOTORCYCLE', '29B-98765', 'ACTIVE',
 '2026-02-05 07:15:00',
 15, 12, 320.75, '2024-03-20 09:00:00'),

(103, 1, 'collector3@example.com', 'Lê Văn C', 'COL-003',
 'TRUCK', '29C-54321', 'INACTIVE',
 '2026-02-04 18:00:00',
 100, 95, 2500.00, '2023-11-01 10:00:00'),

(104, 1, 'collector4@example.com', 'Phạm Thị D', 'COL-004',
...
SET @col1 = (SELECT id FROM collectors WHERE user_id = 101);
SET @col2 = (SELECT id FROM collectors WHERE user_id = 102);

INSERT IGNORE INTO collection_requests (request_code, report_id, enterprise_id, collector_id,
...
SET @req1 = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260205-001');
SET @req2 = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260205-002');
SET @req3 = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260205-003');
SET @req4 = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260204-001');
SET @req5 = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260203-001');
SET @col1 = (SELECT id FROM collectors WHERE user_id = 101);
...
SET @req4_report = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260204-001');
SET @req5_report = (SELECT id FROM collection_requests WHERE request_code = 'REQ-20260203-001');
SET @col1_report = (SELECT id FROM collectors WHERE user_id = 101);

INSERT IGNORE INTO collector_reports (collection_request_id, collector_id, status,
                               collector_note, collected_at, latitude, longitude, created_at)
VALUES
(@req4_report, @col1_report, 'COMPLETED',
 'Đã thu gom thành công 15.5kg rác tái chế. Khu vực sạch sẽ.',
 '2026-02-04 09:00:00', 10.77800000, 106.70800000, '2026-02-04 09:00:00'),

(@req5_report, @col1_report, 'COMPLETED',
 'Thu gom 22.3kg rác sinh hoạt. Không có vấn đề gì.',
...
SET @report1 = (SELECT id FROM collector_reports ORDER BY id ASC LIMIT 1);
SET @report2 = (SELECT id FROM collector_reports ORDER BY id DESC LIMIT 1);
...
SELECT '' AS '=== 1. COLLECTORS SUMMARY ===';
SELECT 
    c.employee_code,
    c.full_name,
    c.status,
    ...
    CASE c.status
        WHEN 'AVAILABLE' THEN '✅ Sẵn sàng'
        WHEN 'ACTIVE' THEN '🔵 Đang làm'
        WHEN 'INACTIVE' THEN '⏸️ Nghỉ'
        WHEN 'SUSPEND' THEN '❌ Tạm ngừng'
    END AS status_display
FROM collectors c
WHERE c.enterprise_id = 1
ORDER BY c.id;

SELECT '' AS '=== 2. COLLECTOR 1 TASKS ===';
SELECT 
    cr.request_code,
    cr.status,
    wr.address,
...
SELECT '' AS '=== 3. COLLECTION TRACKING AUDIT LOG ===';
SELECT 
    cr.request_code,
    ct.action,
    ct.note,
...
SELECT '' AS '=== 5. ACTIVE TASKS PER COLLECTOR ===';
SELECT 
    c.employee_code,
    c.full_name,
...
SELECT 'Collectors: 4 (AVAILABLE: 1, ACTIVE: 1, INACTIVE: 1, SUSPEND: 1)' AS Collectors;
SELECT 'Collection Requests: 8' AS Requests;
SELECT 'Collection Tracking Logs: 14' AS Logs;
SELECT 'Collector Reports: 2' AS Reports;
SELECT 'Report Images: 5' AS Images;
SELECT '✅ All collector-related data inserted successfully!' AS Status;
